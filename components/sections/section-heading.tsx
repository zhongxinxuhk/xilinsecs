...
export default function SectionHeading({ kicker, title, description, icon: Icon }: SectionHeadingProps) {
  return (
    <div className="min-w-0 max-w-3xl">
      ...
      <h2 className="heading-display mt-4 flex min-w-0 flex-col items-start gap-3 text-3xl font-semibold tracking-tight text-slate-950 sm:flex-row sm:items-center md:text-4xl">
